...
|   <img src="assets/aleksei_popov.png" width="150"> |  <img src="assets/egor_dubrovin.png" width="150">  |  <img src="assets/bader_rasheed.png" width="150">  |  <img src="assets/bogdan_salyp.png" width="150">  |  <img src="assets/anon.png" width="150">  |  <img src="assets/dulshan_heva_kodippilige.png" width="150">  |
|: --------------------------------------- :|: --------------------------------------- :|
...
- [День 3. Алгоритмы машинного обучения](#4)
	...
	- [Предварительная обработка данных](#4_2)
		...
		- [Масштабирование](#4_2_2)
		- [Уменьшение размерности](#4_2_3)
		- [Алгоритм отбора признаков](#4_2_4)
		...
		- [Cтохастическое вложение соседей с t-распределением](#4_2_12)
		- [Унифицированная аппроксимация и проекция многообразия](#4_2_13)
		- [Краткий обзор алгоритмов и методов уменьшения размерности](#4_2_14)
			- [Соотношение пропущенных значений](#4_2_14_1)
			- [Фильтр низкой дисперсии](#4_2_14_2)
			- [Фильтр высокой корреляции](#4_2_14_3)
			- [Случайный лес](#4_2_14_4)
			- [Факторный анализ](#4_2_14_5)
			- [Анализ основных компонентов](#4_2_14_6)
		- [Разделение набора данных](#4_2_20)
